...
class Alert(v.Alert, SepalWidget):
    ...
    def __init__(self, type_=None, **kwargs):
        ...
        super().__init__(children=[""], type=type_, text=True, class_="mt-5", **kwargs)
    ...
    def bind(self, widget, obj, variable, msg=None):
        ...
        widget.on_event(
            "change",
            partial(on_change, obj=obj, variable=variable, output=self, msg=msg),
        )
...
class AppBar(v.AppBar, SepalWidget):
    ...
    def __init__(self, title="SEPAL module", **kwargs):
        ...
        def setTitle(self, title):
            ...
            self.children = [self.toolBarButton, v.ToolbarTitle(children=[title])]
...
class Tile(v.Layout, SepalWidget):
    ...
    def __init__(self, id_, title, inputs=[""], btn=None, output=None, **kwargs):
        ...
        card = v.Card(class_="pa-5", raised=True, xs12=True, children=[title] + content)
    ...
    def get_items(self):
        ...
        parent_item = v.ListItem(
            ...
            children=[
                v.ListItemAction(
                    children=[
                        v.Icon(color="black", children=["mdi-folder-upload-outline"])
                    ]
                ),
                v.ListItemContent(
