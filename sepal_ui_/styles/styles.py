...
ICON_TYPES = {
    # Used for folders
    "": {"color": "amber", "icon": "mdi-folder-outline"},
    ".csv": {"color": "green accent-4", "icon": "mdi-border-all"},
    ".txt": {"color": "green accent-4", "icon": "mdi-border-all"},
    ".tif": {"color": "deep-purple", "icon": "mdi-image-outline"},
    ".tiff": {"color": "deep-purple", "icon": "mdi-image-outline"},
    ".shp": {"color": "deep-purple", "icon": "mdi-vector-polyline"},
    "DEFAULT": {"color": "light-blue", "icon": "mdi-file-outline"},
    # Icon for parent folder
    "PARENT": {"color": "black", "icon": "mdi-folder-upload-outline"},
}
